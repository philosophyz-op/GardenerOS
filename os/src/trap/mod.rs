...
fn set_kernel_trap_entry() {
    unsafe { stvec::write(trap_from_kernel as *const () as usize, TrapMode::Direct); }
}

fn set_user_trap_entry() {
    unsafe { stvec::write(TRAMPOLINE as *const () as usize, TrapMode::Direct); }
}
...
pub fn trap_handler() -> ! {
    ...
    match scause.cause() {
        ...
        Trap::Exception(Exception::StoreFault) | Trap::Exception(Exception::StorePageFault) => {
            println!("[kernel] PageFault: sepc={:#x}, bad addr={:#x}, stval={:#x}, satp={:#x}", cx.sepc, stval, stval, satp::read());
...
pub fn trap_return() -> ! {
    ...
    extern "C" { fn __alltraps(); fn __restore(); }
